// Generated from /user/3/dasilbre/ensimag/GL/Projet_GL/src/main/antlr4/fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.13.1
...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		...
		AND=46, OR=47, INT=48, FLOAT=49, STRING_CAR=50, STRING=51, MULTI_LINE_STRING=52, 
		COMMENT=53, INCLUDE=54;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INT", "FLOAT", "STRING_CAR", "STRING", "MULTI_LINE_STRING", "COMMENT", 
			"INCLUDE"
		};
	}
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3101792099303264L) != 0)) {
				{
				{
				setState(122);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					            ...
					            curElseBranch.add(new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree, ((If_then_elseContext)_localctx).elsif_li.tree, newElseBranch));
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3097394051551008L) != 0)) {
				{
				setState(214);
