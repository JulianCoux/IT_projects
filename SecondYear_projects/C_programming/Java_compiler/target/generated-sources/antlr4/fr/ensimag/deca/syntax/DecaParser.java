...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		...
		COMMENT=53, FILENAME=54, INCLUDE=55;
	public static final int
				...
				if ( _alt==1 ) {
					...
					case 1:
						...
						match(CPARENT);
						                      ...
						                      ((Select_exprContext)_localctx).tree =  new Selection(((Select_exprContext)_localctx).e1.tree, ((Select_exprContext)_localctx).i.tree, ((Select_exprContext)_localctx).args.tree);
		...
		try {
			...
			case 2:
				...
				match(CPARENT);
				            ...
				            // TODO: Needs to somehow add the args to the function
		...
		try {
			...
			case THIS:
				...
				match(THIS);
				            ...
				            ((LiteralContext)_localctx).tree =  new Identifier(getDecacCompiler().symbolTable.create("this"));
			...
			case NULL:
				...
				match(NULL);
				            ...
				            ((LiteralContext)_localctx).tree =  new StringLiteral("null");
				            //((LiteralContext)_localctx).tree =  new NullType(getDecacCompiler().symbolTable.create("null"));
